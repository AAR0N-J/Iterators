...
{
    private StringBuilder theString;       // declare a StringBuilder to refer to the CharIterators source  
                                           // StringBuilder lets you remove/add items from/to the StringBuilder object
